...
from mmdet3d.compat import LOSSES
...
try:
    ...
    try:
        # 常见于 MMDet3D 0.17+ 路径
        from mmdet3d.core.bbox.iou_calculators import AxisAlignedBboxOverlaps3D
    except ImportError:
        # 适配 MMDet3D 1.x 路径
        try:
            from mmdet3d.models.task_modules import AxisAlignedBboxOverlaps3D
        except ImportError:

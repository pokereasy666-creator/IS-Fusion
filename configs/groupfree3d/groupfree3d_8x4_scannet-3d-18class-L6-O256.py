...
param_scheduler = [dict(type='MultiStepLR', milestones=[56, 68], gamma=0.1, by_epoch=True)]

# runtime settings
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=80, val_interval=1)
default_hooks = dict(checkpoint=dict(type='CheckpointHook', interval=1, max_keep_ckpts=10))
